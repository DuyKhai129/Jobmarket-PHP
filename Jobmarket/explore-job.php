			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="job-list.php">Tất cả các công việc</a></li>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<div class="meta-div clearfix mb-25">
										<span>tại  <a target="_blank" href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a> với tư cách là </span>
										<?php echo "$sta"; ?>
									</div>
								...
								<div class="job-detail-company-overview clearfix">
									...
									<div class="image">
										<?php 
										if ($complogo == null) {
										print '<center>Không có biểu trưng công ty</center>';
										}else{
						        ...
						        if ($user_online == true) {
								if ($jobexpired == true) {
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-calendar"></i> Công việc này đã hết hạn</button>';
								}else{
								if ($myrole == "employee") {
                                print '<button';?> onclick="update(this.value)" <?php print ' value="'.$jobid.'" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i>Ứng tuyển công việc này</button>';
								}else{
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Đăng nhập với tư cách nhân viên để ứng tuyển</button>';
								}	
								}
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i>Đăng nhập để ứng tuyển công việc này</button>';	
								}
								...
								<div class="tab-style-01">
									...
									<ul class="nav" role="tablist">
										<li role="presentation" class="active"><h4><a href="#relatedJob1" role="tab" data-toggle="tab">Công việc khác từ <?php echo "$compname"; ?></a></h4></li>
									</ul>
