				...
				<div class="container">
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
							...
							<p class="mata-p clearfix"><span class="text-primary font700"></span> <span class="font13">Đang hoạt động</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right"></i></span></p>
							</div>
