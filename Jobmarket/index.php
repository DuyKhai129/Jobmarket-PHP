		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>Tương lai tươi sáng của bạn bắt đầu ở đây ngay bây giờ</h1>
					<p>Tìm công việc hoặc sự nghiệp tiếp theo của bạn trên JOB MARKET</p>
