							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="section-title mb-40">
										...
										<h4 class="text-left">Công việc được cung cấp tại: <?php echo "$compname"; ?></h4>
										 ...
										 ?>
											...
											<div class="content">
												<div class="job-item-list-info">
													...
													<div class="row">
														...
														<div class="col-sm-7 col-md-8">
															...
															<span>tại <a href="company.php?ref=<?php echo "$company_id"; ?>"><?php echo "$compname"; ?></a></span>
															<?php echo "$sta"; ?>
															</div>
												...
												<div class="job-item-list-bottom">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">Xem công việc này</a>
													</div>
