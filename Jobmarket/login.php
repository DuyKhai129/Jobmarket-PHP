			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li><span>truy cập tài khoản của bạn</span></li>
					</ol>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <input class="form-control" placeholder="Nhập địa chỉ email của bạn" name="email" required type="text"> 
                                </div>
                                ...
                                <input class="form-control" placeholder="Nhập mật khẩu của bạn" name="password" required type="password"> 
                                </div>
...
Nhập địa chỉ email được liên kết với tài khoản của bạn, chúng tôi sẽ gửi cho bạn liên kết để đặt lại mật khẩu của bạn</p>
						...
						<div class="col-sm-12 col-md-12">
							...
							<div class="form-group"> 
								...
								<label>Địa chỉ email</label>
								<input id="mymail" autocomplete="off" name="email" class="form-control" placeholder="Nhập địa chỉ email của bạn" type="email" required> 
							</div>
