											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-8 col-md-8">
													...
													<div class="form-group">
														<label>Chức vụ</label>
														<input name="title" value="<?php echo "$jobtitle"; ?>" required type="text" class="form-control" placeholder="Nhập chức vụ">
													</div>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<input name="city" value="<?php echo "$jobcity"; ?>"  required type="text" class="form-control" placeholder="Nhập thành phố">
													</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($experience == "Expert") { print ' selected '; } ?> value="Expert">Thông thạo</option>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea class="form-control bootstrap3-wysihtml5" name="description" required placeholder="Nhập mô tả công việc ..." style="height: 200px;"><?php echo "$jobdescription"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="responsiblities" required class="form-control bootstrap3-wysihtml5" placeholder="Nhập các trách nhiệm..." style="height: 200px;"><?php echo "$jobrespo"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Yêu cầu</label>
														<textarea name="requirements" required class="form-control bootstrap3-wysihtml5" placeholder="Nhập các yêu cầu..." style="height: 200px;"><?php echo "$jobreq"; ?></textarea>
													</div>
