			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Công việc đã đăng</span></li>
					</ol>
									...
									<?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   ?>
											...
											<p class="date text-muted font12 font-italic">Hạn cuối - <?php echo "$deadline"; ?></p>
											</div>
											...
											<a target="_blank" href="view-applicants.php?jobid=<?php echo $row['job_id']; ?>">Ứng viên</a>
											<a href="edit-job.php?jobid=<?php echo $row['job_id']; ?>">Chỉnh sửa</a>
											<a onclick = "return confirm('Bạn có chắc chắn muốn xóa công việc này không?')" href="app/drop-job.php?id=<?php echo $row['job_id']; ?>">Xóa</a>
											</div>
											</div>
