			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Ứng viên cho công việc <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Ứng viên cho công việc <?php echo "$job_title"; ?></</h3>
						</div>
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
											...
											<div class="content">
												...
												<h6 class="text-primary">Giáo dục : <?php echo $rowb['education'] ?></h6>
