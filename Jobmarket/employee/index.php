							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Tên</label>
														<input name="fname" required type="text" class="form-control" value="<?php echo "$myfname"; ?>" placeholder="Nhập tên">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Họ</label>
														<input name="lname" required type="text" class="form-control" value="<?php echo "$mylname"; ?>" placeholder="Nhập họ">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Email</label>
														<input type="email" name="email" required class="form-control" value="<?php echo "$myemail"; ?>" placeholder="Nhập địa chỉ email">
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-md-4">
                                                    <input value="<?php echo "$myedu"; ?>" name="education" type="text" required class="form-control" placeholder="Vd: Văn bằng, Bằng cấp ... vv">
													</div>
													...
													<div class="col-sm-6 col-md-4">
														...
														<input value="<?php echo "$mytitle"; ?>" name="title" required type="text" class="form-control mb-15" placeholder="Vd: Khoa học máy tính, CNTT ... vv">
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Về tôi</label>
														<textarea name="about" class="bootstrap3-wysihtml5 form-control" placeholder="Nhập mô tả ngắn của bạn ..." style="height: 200px;"><?php echo "$mydesc"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 mt-10">
													...
													<button type="reset" class="btn btn-primary btn-inverse">Hủy bỏ</button>
												</div>
										...
										?><a onclick = "return confirm('Bạn có chắc chắn muốn xóa hình đại diện của mình không ?')" class="btn btn-primary btn-inverse" href="app/drop-dp.php">Xóa</a> <?php
										}
										?>
										</div>
										</div>
