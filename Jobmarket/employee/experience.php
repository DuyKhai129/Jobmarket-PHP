						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-experience.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Bạn có chắc chắn muốn xóa trải nghiệm này không ?')" class="btn btn-primary btn-sm btn-inverse">Xóa</a>
									...
									<b style="color:#990000">Tất cả các trường có dấu * là bắt buộc</b>
								    ...
								    <input value="<?php echo "$institution"; ?>" class="form-control" placeholder="Nhập tên tổ chức" type="text" name="institution" required> 
							        </div>
								    ...
								    <input value="<?php echo "$supervisor"; ?>" class="form-control" placeholder="Nhập tên người giám sát" type="text" name="supervisor"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Điện thoại giám sát</label>
								    <input value="<?php echo "$phone"; ?>" class="form-control" placeholder="Nhập Điện thoại người giám sát" type="text" name="telphone"> 
							        </div>
								    ...
								    <input  value="<?php echo "$title"; ?>" class="form-control" placeholder="Nhập Chức vụ" type="text" name="jobtitle" required> 
							        </div>
								    ...
								    <input  value="<?php echo "$start_date"; ?>" class="form-control" placeholder="Vd: 13-01-2017" type="text" name="startdate" required> 
							        </div>
								    ...
								    <input  value="<?php echo "$end_date"; ?>" class="form-control" placeholder="Vd: 01-12-2017" type="text" name="enddate" required> 
							        </div>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Tên người giám sát</label>
								    <input class="form-control" placeholder="Nhập tên người giám sát" type="text" name="supervisor"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Điện thoại giám sát</label>
								    <input class="form-control" placeholder="Nhập Điện thoại người giám sát" type="text" name="telphone"> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Chức vụ<b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Nhập Chức vụ" type="text" name="jobtitle" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Ngày bắt đầu <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Vd: 01/03/2017" type="text" name="startdate" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Ngày kết thúc <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Vd: 01/06/2017" type="text" name="enddate" required> 
							        </div>
