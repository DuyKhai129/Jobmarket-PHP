						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-ref.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Bạn có chắc chắn muốn xóa chứng nhận này không ?')" class="btn btn-primary btn-sm btn-inverse">Xóa</a>
								    ...
								    <input class="form-control" value="<?php echo "$refname"; ?>" placeholder="Nhập tên người giới thiệu" type="text" name="name" required> 
							        </div>
								    ...
								    <input class="form-control" value="<?php echo "$refmail"; ?>"placeholder="Nhập Email giới thiệu" type="email" name="email" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Chức danh người giới thiệu</label>
								    <input class="form-control" value="<?php echo "$reftitle"; ?>" placeholder="Nhập chức danh người giới thiệu" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Điện thoại giới thiệu</label>
								    <input class="form-control" value="<?php echo "$refphone"; ?>" placeholder="Nhập điện thoại giới thiệu" type="text" name="phone" required> 
							        </div>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Thêm người giới thiệu</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Tên người giới thiệu</label>
								    <input class="form-control" placeholder="Nhập tên người giới thiệu" type="text" name="name" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Email giới thiệu</label>
								    <input class="form-control" placeholder="Nhập email giới thiệu" type="email" name="email" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>chức danh người giới thiệu</label>
								    <input class="form-control" placeholder="Nhập chức danh người giới thiệu" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Điện thoại giới thiệu</label>
								    <input class="form-control" placeholder="Nhập điện thoại giới thiệu" type="text" name="phone" required> 
							        </div>
