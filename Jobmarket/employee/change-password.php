                                             ...
                                             <?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input type="password" class="form-control" name="password" required placeholder="Nhập mật khẩu mới của bạn">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input type="password" class="form-control"  name="confirmpassword" required placeholder="Xác nhận mật khẩu mới của bạn">
													</div>
													
												</div>
												
												<div class="col-sm-12 mt-10">
													<button type="submit" onclick="return check_passwords();" class="btn btn-primary">Cập nhập</button>
													<button type="reset" class="btn btn-primary btn-inverse">Hủy bỏ</a>
												</div>
