						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-training.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Bạn có chắc chắn muốn xóa khóa đào tạo này không ?')" class="btn btn-primary btn-sm btn-inverse">Xóa</a>
								    ...
								    <input class="form-control" value="<?php echo "$training"; ?>" placeholder="Nhập Tên đào tạo" type="text" name="training" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Đính kèm chứng chỉ của bạn <b>*(Để trống nếu bạn không muốn cập nhật)*</b></label>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Đã tham dự đào tạo & hội thảo</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Tên đào tạo</label>
								    <input class="form-control" placeholder="Nhập tên đào tạo" type="text" name="training" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Đính kèm chứng chỉ của bạn (tùy chọn)</label>
								    <input class="form-control" accept="application/pdf" type="file" name="certificate"> 
							        </div>
