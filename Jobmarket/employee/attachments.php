			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Các tệp đính kèm khác</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-attachment.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Bạn có chắc chắn muốn xóa phần đính kèm này không ?')" class="btn btn-primary btn-sm btn-inverse">Xóa</a>
								    ...
								    <input class="form-control" value="<?php echo "$att_title"; ?>" placeholder="Vd: giấy khai sinh, giấy phép lái xe" type="text" name="title" required> 
							        </div>
								    ...
								    <input class="form-control" value="<?php echo "$att_issuer"; ?>" placeholder="Nhập người phát hành" type="text" name="issuer" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Chọn phần đính kèm <i>(Để trống nếu bạn không muốn cập nhật)</i></label>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Thêm tệp đính kèm</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Loại tệp đính kèm</label>
								    <input class="form-control" placeholder="Vd: giấy khai sinh, giấy phép lái xe" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Người phát hành</label>
								    <input class="form-control" placeholder="Nhập người phát hành" type="text" name="issuer" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Chọn phần đính kèm</label>
